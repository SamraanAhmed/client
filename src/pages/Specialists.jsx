  ...
  const specialists = [
    {
      ...
      description:
        'Specialized in complex oral and facial surgical procedures with advanced techniques for optimal patient outcomes and recovery.',
    ...
    },
    {
      ...
      description:
        'Expert in dental prosthetics and root canal therapy, combining precision craftsmanship with advanced endodontic techniques.',
    ...
    },
    {
      ...
      description:
        'Dedicated to creating beautiful, straight smiles using modern orthodontic techniques and personalized treatment plans.',
    ...
    },
    {
      ...
      description:
        'Specializes in facial and jaw surgery procedures, providing comprehensive care for complex oral and facial conditions.',
    ...
    },
    {
      ...
      description:
        "Gentle and caring approach to children's dental health, making dental visits comfortable and fun for young patients.",
    ...
    },
    {
      ...
      qualifications:
        'FCPS in Operative Dentistry, Certified Dentition Specialist',
      specialty: 'Operative Dentistry',
      image:
        'https://images.unsplash.com/photo-1551601651-2a8555f1a136?w=300&h=300&fit=crop&crop=face',
      description:
        'Expert in restorative and cosmetic dentistry procedures, focusing on preserving natural teeth with advanced techniques.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-primary-100 max-w-3xl mx-auto">
              ...
              providing you with the highest quality care using the latest
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-neutral-600 dark:text-neutral-300 max-w-3xl mx-auto">
              Each of our specialists brings years of experience and specialized
              training to provide you with exceptional care.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-neutral-50 dark:bg-neutral-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-neutral-600 dark:text-neutral-300 max-w-3xl mx-auto">
              From routine care to complex surgical procedures, our specialists
              cover every aspect of dental health.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-100">
              Schedule a consultation with one of our expert specialists today
              and take the first step toward optimal oral health.
            </p>
