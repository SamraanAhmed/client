...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      action: { text: 'Book Online', href: '/book', icon: <CheckCircle className="w-4 h-4" /> }
    }
  ]
  ...
  const stats = [
    { icon: <Users className="w-8 h-8" />, number: '5,000+', label: 'Happy Patients' },
    { icon: <Star className="w-8 h-8" />, number: '4.9', label: 'Average Rating' },
    { icon: <Award className="w-8 h-8" />, number: '15+', label: 'Years Experience' },
    { icon: <Shield className="w-8 h-8" />, number: '24/7', label: 'Emergency Care' }
  ]
        ...
        >
          <Card className="p-8 shadow-xl">
            ...
            <p className="text-neutral-600 mb-6 leading-relaxed">
              Thank you for reaching out to us. Our team will get back to you within 24 hours during business days.
            </p>
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              >
                <Card className="p-6 h-full hover:shadow-xl transition-all duration-300 border-0 bg-white">
                  <div className="text-center">
                    <div className={`inline-flex p-4 rounded-2xl ${info.color} mb-4 group-hover:scale-110 transition-transform duration-300`}>
                      {info.icon}
                    </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <p className="text-sm text-blue-800">
                            <strong>Quick Response:</strong> We typically respond to messages within 24 hours during business days. 
                            For urgent dental emergencies, please call our emergency line at <strong>(555) 123-4568</strong>.
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              >
                <Card className="overflow-hidden shadow-xl border-0">
                  <div className="p-6 bg-gradient-to-r from-primary-500 to-primary-600 text-white">
                    <h3 className="text-xl font-bold mb-2">Find Our Location</h3>
                    <p className="text-primary-100">Easy to reach, convenient parking</p>
                  </div>
                ...
                <Card className="p-6 shadow-xl border-0">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3 p-3 rounded-lg bg-green-50 border border-green-200">
                      ...
                      <div>
                        <p className="font-medium text-green-800">Free Parking</p>
                        <p className="text-sm text-green-700">Adjacent garage with easy access</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3 p-3 rounded-lg bg-blue-50 border border-blue-200">
                      ...
                      <div>
                        <p className="font-medium text-blue-800">Wheelchair Accessible</p>
                        <p className="text-sm text-blue-700">Elevator access to all floors</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3 p-3 rounded-lg bg-purple-50 border border-purple-200">
                      <MapPin className="w-5 h-5 text-purple-600 mt-0.5" />
                      <div>
                        <p className="font-medium text-purple-800">Easy to Find</p>
                        <p className="text-sm text-purple-700">3rd floor, Suite 301</p>
                      </div>
                    </div>
                  </div>
                </Card>
      ...
      <section className="py-16 bg-gradient-to-r from-red-500 to-red-600 text-white relative overflow-hidden">
        <div className={"absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width=\"40\" height=\"40\" viewBox=\"0 0 40 40\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cg fill=\"%23ffffff\" fill-opacity=\"0.1\"%3E%3Cpath d=\"M20 20c0 11.046-8.954 20-20 20s-20-8.954-20-20 8.954-20 20-20 20 8.954 20 20zm0-20c11.046 0 20 8.954 20 20s-8.954 20-20 20-20-8.954-20-20 8.954-20 20-20z\"/%3E%3C/g%3E%3C/svg%3E')] opacity-20"}></div>
